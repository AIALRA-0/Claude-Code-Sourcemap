 ...
 *
 * `url.full` **MUST NOT** contain credentials passed via URL in form of `https://username@www.example.com/`.
 * In such case username and password **SHOULD** be redacted and attribute's value **SHOULD** be `https://REDACTED@www.example.com/`.
 *
