 ...
 *
 * Note: `http.url` MUST NOT contain credentials passed via URL in form of `https://username@www.example.com/`. In such case the attribute&#39;s value should be `https://www.example.com/`.
 *
